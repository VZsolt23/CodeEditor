...
- [ ] Map remaining LSP features: rename, formatting → same editor plumbing Roslyn uses (hover + completion + definition + references done; consider a common `ILanguageService` facade routed by `LanguageInfo.Id`)
